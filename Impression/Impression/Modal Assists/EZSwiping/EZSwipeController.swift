...
public class EZSwipeController: UIViewController {
    ...
    public struct Constants {
        ...
        public static let lightGrayColor = UIColor(red: 163/255, green: 190/255, blue: 201/255, alpha: 1)
    }
    ...
    private func setupStatusBarBackground(){
        let view = UIView(frame:
            CGRect(x: 0.0, y: 0.0, width: UIScreen.mainScreen().bounds.size.width, height: 64.0)
        )
        view.backgroundColor = UIColor(red: 163/255, green: 190/255, blue: 201/255, alpha: 1)
        ...
        for index in 0..<stackVC.count {
            ...
            if let nav = navigationBar {
                if navigationBarShouldBeOnBottom {
                    ...
                    nav.frame = CGRect(x: 0.0, y: 0.0, width: Constants.ScreenWidth, height: Constants.navigationBarHeight)
                }
