...
public class Validator {
    ...
    public func registerField(textField:UITextField, rules:[Rule]) {
        validations[textField] = ValidationRule(textField: textField, rules: rules, errorLabel: nil, image: nil, viewConstraint: nil, lineConstraint: nil, errorConstraint: nil, line: nil, validIcon: nil)
    }
    
    public func registerField(textField:UITextField, errorLabel:UILabel, rules:[Rule], image: UIImageView, viewConstraint: NSLayoutConstraint?, lineConstraint: NSLayoutConstraint, errorConstraint: NSLayoutConstraint, line: UIView, validIcon: UIImage) {
        validations[textField] = ValidationRule(textField: textField, rules:rules, errorLabel:errorLabel, image: image, viewConstraint: viewConstraint, lineConstraint: lineConstraint, errorConstraint: errorConstraint, line: line, validIcon: validIcon)
    }
